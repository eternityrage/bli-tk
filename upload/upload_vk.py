"""
Upload videos to VK (VKontakte) - BlissTok Lens
"""
import os
import vk_api
...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        message = description if description else "BlissTok Lens - Cate Blanchett Moments!\n\n#cateblanchett #hollywood #celebrity #fashion"
        ...
        video = upload.video(
            ...
            name=title or 'BlissTok Lens Video',
